...
// Thread-safe random clue generator with persistent swap-and-pop pool (numbpool2 logic)
// Separates state files/ranges by specific game variant to prevent collision
inline int getRandomClues(const std::string& game_name, int min, int max) {
  ...
  // Acquire cross-process/cross-thread lock for the entire read-modify-write duration
  ...
  if (outfile.is_open()) {
    for (const auto& pair : pools) {
      outfile << pair.first << " " << pair.second.first.first << " " << pair.second.first.second << " :";
...
inline const PuzzleConfig& getSudokuMiniConfig() {
  static const PuzzleConfig config = PuzzleConfig{getRandomClues("sudoku_mini", 12, 15), 3, 3, 3, 6, false, false, 6, false, false};
  return config;
}
...
inline const PuzzleConfig& getSudokuAConfig() {
  static const PuzzleConfig config = PuzzleConfig{getRandomClues("sudoku_a", 18, 27), 4, 4, 4, 9, false, false, 9, false, false};
  return config;
}
...
inline const PuzzleConfig& getSudokuXConfig() {
  static const PuzzleConfig config = PuzzleConfig{getRandomClues("sudoku_x", 28, 40), 5, 5, 5, 5, true, false, 9, false, false};
  return config;
}
...
inline const PuzzleConfig& getWindokuConfig() {
  static const PuzzleConfig config = PuzzleConfig{getRandomClues("windoku", 28, 40), 5, 5, 5, 9, false, false, 5, true, false};
  return config;
}
...
inline const PuzzleConfig& getWindokuXConfig() {
  static const PuzzleConfig config = PuzzleConfig{getRandomClues("windoku_x", 27, 36), 4, 4, 4, 4, true, false, 4, true, false};
  return config;
}
...
inline const PuzzleConfig& getJigsaw8Config() {
  static const PuzzleConfig config = PuzzleConfig{getRandomClues("jigsaw_8", 23, 32), 5, 5, 5, 8, false, false, 8, false, false};
  return config;
}
...
inline const PuzzleConfig& getJigsaw9Config() {
  static const PuzzleConfig config = PuzzleConfig{getRandomClues("jigsaw_9", 28, 40), 5, 5, 5, 9, false, false, 9, false, false};
  return config;
}
...
inline const PuzzleConfig& getJigsawXConfig() {
  static const PuzzleConfig config = PuzzleConfig{getRandomClues("jigsaw_x", 28, 40), 5, 5, 5, 5, true, false, 9, false, false};
  return config;
}
...
inline const PuzzleConfig& getWindokuJigsawConfig() {
  static const PuzzleConfig config = PuzzleConfig{getRandomClues("windoku_jigsaw", 28, 40), 5, 5, 5, 9, false, false, 5, true, false};
  return config;
}
...
inline const PuzzleConfig& getSudoku12Config() {
  static const PuzzleConfig config = PuzzleConfig{getRandomClues("sudoku_12", 54, 72), 7, 7, 7, 12, false, false, 12, false, false};
  return config;
}
...
inline const PuzzleConfig& getDozakuConfig() {
  static const PuzzleConfig config = PuzzleConfig{getRandomClues("dozaku", 54, 72), 7, 7, 7, 12, false, false, 12, false, false};
  return config;
}
...
inline const PuzzleConfig& getTwodokuMiniConfig() {
  static const PuzzleConfig config = PuzzleConfig{getRandomClues("twodoku_mini", 24, 30), 3, 3, 3, 6, false, false, 6, false, false};
  return config;
}
...
inline const PuzzleConfig& getTwodoku8Config() {
  static const PuzzleConfig config = PuzzleConfig{getRandomClues("twodoku_8", 48, 56), 5, 5, 5, 8, false, false, 8, false, false};
  return config;
}
...
inline const PuzzleConfig& getTwodoku9Config() {
  static const PuzzleConfig config = PuzzleConfig{getRandomClues("twodoku_9", 72, 81), 5, 5, 5, 9, false, false, 9, false, false};
  return config;
}
